...
@interface VMNexusDOSBoxProcess ()
@property (nonatomic, strong, readwrite) VMNexusVirtualMachine *virtualMachine;
@property (nonatomic, assign, readwrite) BOOL isRunning;
@property (nonatomic, strong) NSTask *task;
@end

@implementation VMNexusDOSBoxProcess

@synthesize delegate;

- (VMNexusEngineType)engineType { return VMNexusEngineTypeDOSBox; }
...
- (BOOL)startWithError:(NSError **)error {
    NSString *binPath = [VMNexusEngineSelector executablePathForEngineType:VMNexusEngineTypeDOSBox];
    if (!binPath) {
