...
@interface VMNexusMednafenProcess ()
@property (nonatomic, strong, readwrite) VMNexusVirtualMachine *virtualMachine;
@property (nonatomic, assign, readwrite) BOOL isRunning;
@property (nonatomic, strong) NSTask *task;
@end

@implementation VMNexusMednafenProcess

@synthesize delegate;

- (VMNexusEngineType)engineType { return VMNexusEngineTypeMednafen; }
...
- (BOOL)startWithError:(NSError **)error {
    NSString *binPath = [VMNexusEngineSelector executablePathForEngineType:VMNexusEngineTypeMednafen];
    if (!binPath) {
