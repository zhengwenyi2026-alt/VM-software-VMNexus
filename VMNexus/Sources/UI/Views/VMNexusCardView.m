...
#pragma mark - VMNexusCardView

@implementation VMNexusCardView
...
#pragma mark - VMNexusStatusBadge

@implementation VMNexusStatusBadge
...
#pragma mark - VMNexusModeSwitcher

@implementation VMNexusModeSwitcher {
...
- (instancetype)initWithFrame:(NSRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        _currentMode = VMNexusAppModeStandard;
        self.wantsLayer = YES;
...
- (void)popupChanged:(NSPopUpButton *)sender {
    self.currentMode = (VMNexusAppMode)sender.indexOfSelectedItem;
    if (self.onModeChange) self.onModeChange(self.currentMode);
}

- (void)setCurrentMode:(VMNexusAppMode)currentMode {
...
#pragma mark - VMNexusIconButton

@implementation VMNexusIconButton
