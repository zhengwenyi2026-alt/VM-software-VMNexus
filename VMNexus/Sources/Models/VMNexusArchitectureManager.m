...
@implementation VMNexusMachineInfo
@end

@implementation VMNexusArchitectureProfile
...
- (NSArray<NSString *> *)allMachines {
    ...
    if (self.dynamicMachines) {
        for (VMNexusMachineInfo *m in self.dynamicMachines) {
...
@interface VMNexusArchitectureManager ()
@property (nonatomic, strong) NSArray<VMNexusArchitectureProfile *> *profiles;
@end

@implementation VMNexusArchitectureManager

+ (instancetype)sharedManager {
    static VMNexusArchitectureManager *instance = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        instance = [[VMNexusArchitectureManager alloc] init];
...
- (void)loadProfiles {
    ...
    // ========== x86 family ==========
    [profiles addObject:[self profileWithName:@"i386" displayName:@"x86 (32-bit)" arch:VMNexusArchX86
    ...
    [profiles addObject:[self profileWithName:@"x86_64" displayName:@"x86_64 (64-bit)" arch:VMNexusArchX86_64
    ...
    // ========== ARM family ==========
    [profiles addObject:[self profileWithName:@"arm" displayName:@"ARM (32-bit)" arch:VMNexusArchARM
    ...
    [profiles addObject:[self profileWithName:@"aarch64" displayName:@"ARM64 (AArch64)" arch:VMNexusArchAArch64
    ...
    // ========== MIPS family ==========
    [profiles addObject:[self profileWithName:@"mips" displayName:@"MIPS (32-bit)" arch:VMNexusArchMIPS
    ...
    [profiles addObject:[self profileWithName:@"mips64" displayName:@"MIPS64" arch:VMNexusArchMIPS64
    ...
    [profiles addObject:[self profileWithName:@"mipsel" displayName:@"MIPSel (LE)" arch:VMNexusArchMIPSEL
                                       binary:@"qemu-system-mipsel" bitWidth:32 category:@"MIPS"
                              machines:@[@"malta", @"mipssim"] defaultMachine:@"malta"
                                  cpus:@[@"24Kf", @"34Kf", @"74Kf", @"m14k", @"P5600"] defaultCPU:@"24Kf"
                           minMem:32 maxMem:2048 defaultMem:256 accel:NO]];
    
    [profiles addObject:[self profileWithName:@"mips64el" displayName:@"MIPS64el" arch:VMNexusArchMIPS64EL
    ...
    // ========== PowerPC ==========
    [profiles addObject:[self profileWithName:@"ppc" displayName:@"PowerPC (32-bit)" arch:VMNexusArchPPC
    ...
    [profiles addObject:[self profileWithName:@"ppc64" displayName:@"PowerPC64" arch:VMNexusArchPPC64
    ...
    // ========== RISC-V ==========
    [profiles addObject:[self profileWithName:@"riscv32" displayName:@"RISC-V (32-bit)" arch:VMNexusArchRISCV32
    ...
    [profiles addObject:[self profileWithName:@"riscv64" displayName:@"RISC-V (64-bit)" arch:VMNexusArchRISCV64
    ...
    // ========== IBM Mainframe ==========
    [profiles addObject:[self profileWithName:@"s390x" displayName:@"s390x (IBM Z)" arch:VMNexusArchS390x
    ...
    // ========== SPARC ==========
    [profiles addObject:[self profileWithName:@"sparc" displayName:@"SPARC (32-bit)" arch:VMNexusArchSPARC
    ...
    [profiles addObject:[self profileWithName:@"sparc64" displayName:@"SPARC64" arch:VMNexusArchSPARC64
    ...
    // 启动时由 VMNexusEngineSelector 根据 machineType 自动路由到对应引擎
    [profiles addObject:[self profileWithName:@"m68k" displayName:@"Motorola 68000" arch:VMNexusArchM68k
    ...
    [profiles addObject:[self profileWithName:@"avr" displayName:@"AVR (8-bit)" arch:VMNexusArchAVR
    ...
    [profiles addObject:[self profileWithName:@"alpha" displayName:@"DEC Alpha" arch:VMNexusArchAlpha
    ...
    [profiles addObject:[self profileWithName:@"hppa" displayName:@"HP PA-RISC" arch:VMNexusArchHPPA
    ...
    [profiles addObject:[self profileWithName:@"sh4" displayName:@"SuperH SH-4" arch:VMNexusArchSH4
    ...
    [profiles addObject:[self profileWithName:@"sh4eb" displayName:@"SuperH SH-4 (BE)" arch:VMNexusArchSH4EB
                                       binary:@"qemu-system-sh4eb" bitWidth:32 category:@"Embedded"
                              machines:@[@"r2d"] defaultMachine:@"r2d"
                                  cpus:@[@"sh7751", @"sh7751r"] defaultCPU:@"sh7751"
                           minMem:16 maxMem:1024 defaultMem:64 accel:NO]];
    
    [profiles addObject:[self profileWithName:@"microblaze" displayName:@"MicroBlaze" arch:VMNexusArchMicroBlaze
    ...
    [profiles addObject:[self profileWithName:@"microblazeel" displayName:@"MicroBlaze EL" arch:VMNexusArchMicroBlazeEL
                                       binary:@"qemu-system-microblazeel" bitWidth:32 category:@"Embedded"
                              machines:@[@"petalogix-s3adsp1800", @"petalogix-ml605", @"xlnx-zynqmp-pmu"] defaultMachine:@"petalogix-s3adsp1800"
                                  cpus:@[@"default"] defaultCPU:@"default"
                           minMem:16 maxMem:2048 defaultMem:128 accel:NO]];
    
    [profiles addObject:[self profileWithName:@"or1k" displayName:@"OpenRISC 1000" arch:VMNexusArchOR1K
    ...
    [profiles addObject:[self profileWithName:@"loongarch64" displayName:@"LoongArch64" arch:VMNexusArchLoongArch64
    ...
    [profiles addObject:[self profileWithName:@"xtensa" displayName:@"Xtensa" arch:VMNexusArchXtensa
    ...
    [profiles addObject:[self profileWithName:@"xtensaeb" displayName:@"Xtensa (BE)" arch:VMNexusArchXtensaEB
    ...
    [profiles addObject:[self profileWithName:@"tricore" displayName:@"TriCore" arch:VMNexusArchTricore
    ...
    [profiles addObject:[self profileWithName:@"rx" displayName:@"RX (32-bit)" arch:VMNexusArchRX
    ...
    [profiles addObject:[self profileWithName:@"mos6502" displayName:@"MOS 6502 (Commodore)" arch:VMNexusArchMOS6502
    ...
    [profiles addObject:[self profileWithName:@"z80" displayName:@"Z80 (MSX / Spectrum)" arch:VMNexusArchZ80
                                       binary:@"" bitWidth:8 category:@"Retro"
    ...
    [profiles addObject:[self profileWithName:@"multisystem" displayName:@"Multi-System" arch:VMNexusArchMultiSystem
...
- (VMNexusArchitectureProfile *)profileWithName:(NSString *)name displayName:(NSString *)displayName
                                         arch:(VMNexusArchitecture)arch binary:(NSString *)binary
                                     ...
                                     machines:(NSArray<NSString *> *)machines defaultMachine:(NSString *)defaultMachine
                                       ...
                                       minMem:(NSInteger)minMem maxMem:(NSInteger)maxMem defaultMem:(NSInteger)defaultMem
                                        accel:(BOOL)accel {
    VMNexusArchitectureProfile *p = [[VMNexusArchitectureProfile alloc] init];
    p.name = name;
...
- (NSArray<VMNexusArchitectureProfile *> *)profilesForCategory:(NSString *)category {
    return [self.profiles filteredArrayUsingPredicate:[NSPredicate predicateWithBlock:^BOOL(VMNexusArchitectureProfile *p, NSDictionary *bindings) {
...
- (VMNexusArchitectureProfile *)profileForArchitecture:(VMNexusArchitecture)arch {
    for (VMNexusArchitectureProfile *p in self.profiles) {
...
- (NSArray<VMNexusMachineInfo *> *)queryMachinesForBinary:(NSString *)binaryName {
    ...
    for (NSString *line in lines) {
        ...
        if ([scanner scanUpToCharactersFromSet:[NSCharacterSet whitespaceCharacterSet] intoString:&name] && name.length > 0) {
            ...
            VMNexusMachineInfo *info = [[VMNexusMachineInfo alloc] init];
            info.name = name;
...
- (void)refreshDynamicData {
    for (VMNexusArchitectureProfile *profile in self.profiles) {
